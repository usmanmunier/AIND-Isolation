...
def custom_score_2(game, player):
    ...
    return float(abs(y1 - y) + abs(x1 - x))
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def get_move(self, game, time_left):
        ...
        try:
            ...
            ## For iterative deepening i struggled a bit
            ## my mantor, Chirs and udacity slack forum helped me to accomplish this
            depth = 1
            while True:
    ...
    def min_value(self,game,alpha,beta,depth):
        #Course slides for pseudocode
        #Udacity slack forum helped me to complete this
        if self.time_left() < self.TIMER_THRESHOLD:
            raise SearchTimeout()
